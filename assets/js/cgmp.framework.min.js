(function(){function E(g){(function(a){function g(){a("object.cgmp-json-string-placeholder").each(function(s,b){var l=a(b).attr("id"),l=a(b).find("param#json-string-"+l).val(),l=A.searchReplace(l,"'",""),l=l.replace("&quot;",""),c=F(l);if("undefined"===typeof c||!c)return m.fatal("We did not parse JSON from OBJECT param. Aborting map generation .."),!1;if(0<a("div#"+c.id).length){var h=new google.maps.Map(document.getElementById(c.id));z.initMap(h,c.bubbleautopan,parseInt(c.zoom),c.maptype);B.init(h);
    ...
    u&&4<=t?F=a.parseJSON:window.JSON&&window.JSON.parse?F=window.JSON.parse:m.fatal("Using parseJson stub..");var d={},z=function(){var a={};return{initMap:function(b,d,c,h){a=b;b=[];for(var m in google.maps.MapTypeId)b.push(google.maps.MapTypeId[m]);"OSM"==h?(b.push(h),a.mapTypes.set(h,new google.maps.ImageMapType({getTileUrl:function(a,c){return"http://tile.openstreetmap.org/"+c+"/"+a.x+"/"+a.y+".png"},tileSize:new google.maps.Size(256,256),name:"OpenStreet",maxZoom:20}))):"ROADMAP"==h?h=google.maps.MapTypeId.ROADMAP:
    "SATELLITE"==h?h=google.maps.MapTypeId.SATELLITE:"HYBRID"==h?h=google.maps.MapTypeId.HYBRID:"TERRAIN"==h&&(h=google.maps.MapTypeId.TERRAIN);a.setOptions({zoom:c,mapTypeId:h,mapTypeControlOptions:{mapTypeIds:b}})},setMapControls:function(b){a.setOptions(b)}}}(),B=function(){var a={};return{init:function(b){a=b},buildKmlLayer:function(b){if(0>b.toLowerCase().indexOf("http"))return m.error("KML URL must start with HTTP(S). Aborting.."),!1;var l=new google.maps.KmlLayer(b);google.maps.event.addListener(l,
...
(this.excerpt="");"undefined"!==typeof this.validated_address_csv_data&&""!==this.validated_address_csv_data||m.error("Validated address on page: "+this.permalink+" returned empty, perhaps OVER_QUERY_LIMIT when validating on the server..");b(this.validated_address_csv_data,this.title,this.permalink,this.excerpt,v,!0);p++});m.info("Have "+x.length+" destinations for marker Geo mashup..")}function b(f,v,p,b,c,s){if("undefined"===typeof f||""===f)m.fatal("Not parsing empty validated address csv data.. Skipping");
else{f=f.split("|");m.info("CGMP CSV: "+f);for(var k=0;k<f.length;k++){var h=f[k];if(null!=h&&""!=h){var e=h.split(d.sep),h=e[0],g=e[1],n=e[2],e=e[3];-1!=n.indexOf(d.noBubbleDescriptionProvided)&&(n="");g={address:h,animation:google.maps.Animation.DROP,zIndex:k+1,markerIcon:g,customBubbleText:n,markerHoverText:n+" ("+h+")",postTitle:v,postLink:p,postExcerpt:b,infoBubbleContainPostLink:c,geoMashup:s};n=[];-1!=e.indexOf(",")?n=e.split(","):-1!=e.indexOf(";")&&(n=e.split(";"));n[0]=A.trim(n[0]);n[1]=
    A.trim(n[1]);if(""===n[0]||""===n[1])return m.warn("Lat or Long are empty string"),!1;e=new google.maps.LatLng(parseFloat(n[0]).toFixed(8),parseFloat(n[1]).toFixed(8));m.info("Have marker to instrument for: "+h+" for location: "+e);n=e;h=g;if(e=new google.maps.Marker({position:n,title:h.markerHoverText,content:h.address,zIndex:h.zIndex+1E3,map:q})){m.info("Marker instrumented for: "+h.address+" for location: "+n);if(h.markerIcon){g=h.markerIcon;if("undefined"==typeof g||"undefined"===g)g="1-default.png";
    e.setIcon(d.customMarkersUri+g);n=null;n=["4-default.png","5-default.png","6-default.png","7-default.png"];-1!=a.inArray(g,["1-default.png","2-default.png"])?(g=d.customMarkersUri+"msmarker.shadow.png",n=l(g,59,32,0,0,16,33)):-1!=a.inArray(g,n)?(g=d.customMarkersUri+"msmarker.shadow.png",n=l(g,59,32,0,0,21,34)):-1!=g.indexOf("3-default")?(g=d.customMarkersUri+"beachflag_shadow.png",n=l(g,37,32,0,0,10,33)):n=l(d.customMarkersUri+"shadow.png",68,37,0,0,32,38);e.setShadow(n)}t(e,h);M||(B(),M=!0);x.push(e)}}}}}
    function l(a,v,p,b,c,d,e){return new google.maps.MarkerImage(a,new google.maps.Size(v,p),new google.maps.Point(b,c),new google.maps.Point(d,e))}function c(){var f=!1,v=null==r?!1:!0;1<x.length?(a.each(x,function(a,f){y.contains(f.position)||y.extend(f.position)}),f=!0):1==x.length&&(v?(y.extend(x[0].position),f=!0):(q.setCenter(x[0].position),L=q.getZoom(),I=q.getCenter()));f&&(v&&null!=r.getPosition()&&(m.info("Extended bounds with Geo marker position: "+r.getPosition()),y.extend(r.getPosition())),
        C=y,null!=y&&q.fitBounds(y))}function h(){null!=C?q.getCenter()!=C.getCenter()&&(m.info("Panning map back to its original bounds center: "+C.getCenter()),q.fitBounds(C),q.setCenter(C.getCenter())):null!=I&&(m.info("Panning map back to its original center: "+I+" and updated zoom: "+L),q.setCenter(I),q.setZoom(L))}function g(f){a(f+" input#a_address").val("");a(f+" input#b_address").val("");a(f+" input#a_address").removeClass("d_error");a(f+" input#b_address").removeClass("d_error");a("input#"+k+"_avoid_hway").prop("checked",
        !1);a("input#"+k+"_avoid_tolls").prop("checked",!1);a("input#"+k+"_radio_km").prop("checked",!1);a("input#"+k+"_radio_miles").prop("checked",!0)}function t(f,v){var p=E(f.content,v),b="div#direction-controls-placeholder-"+k,c=a("div#rendered-directions-placeholder-"+k);google.maps.event.addListener(f,"click",function(){g(b);a(b).fadeOut();G.setMap(null);c.html("");c.hide();a(b+" button#print_sub").hide();z(f,p,b);u(f,p,b,c);D.setContent(p.bubbleContent);D.setOptions({disableAutoPan:"true"===K?!1:
        !0});D.open(q,this)})}function u(f,b,p,c){var d="div#bubble-"+b.bubbleHolderId,e=f.content,e=e.replace("Lat/Long: ",""),l=!1==(null==r?!1:!0)||null==r.getPosition()?"":r.getPosition();a(document).on("click",d+" a.dirToHereTrigger",function(){this.id==="toHere-"+b.bubbleHolderId&&(a(p).fadeIn(),a(p+" input#a_address").val(l),a(p+" input#b_address").val(e),"miles"===J?(a("input#"+k+"_radio_miles").prop("checked",!0),a("input#"+k+"_radio_km").prop("checked",!1)):"km"===J&&(a("input#"+k+"_radio_km").prop("checked",
        ...
        " status: "+d),a(document).on("click","a#trigger-"+b.bubbleHolderId,function(a){a.preventDefault()}),a("a#trigger-"+b.bubbleHolderId).attr("style","text-decoration: none !important; color: #ddd !important"),google.maps.event.addListener(D,"domready",function(){a("a#trigger-"+b.bubbleHolderId).removeAttr("href");a("a#trigger-"+b.bubbleHolderId).attr("style","text-decoration: none !important; color: #ddd !important")})})}function B(){var f="div#direction-controls-placeholder-"+k,b=a("div#rendered-directions-placeholder-"+
        ...
        this.set("minimum_accuracy",null);this.set("position_options",{enableHighAccuracy:!0,maximumAge:1E3});this.circle_.bindTo("map",this.marker_);a&&this.setMap(a)}var x,J,w,M,q,H,K,C,I,L,k,y,D,N,G,O,r=null;e.prototype=new google.maps.MVCObject;e.prototype.set=function(a,b){if(/^(?:position|accuracy)$/i.test(a))throw"'"+a+"' is a read-only property.";/map/i.test(a)?this.setMap(b):google.maps.MVCObject.prototype.set.apply(this,arguments)};e.prototype.marker_=null;e.prototype.circle_=null;e.prototype.getMap=
        ...
        a&&(r=new e,google.maps.event.addListenerOnce(r,"position_changed",function(){q.setCenter(this.getPosition());q.fitBounds(this.getBounds())}),google.maps.event.addListener(r,"geolocation_error",function(a){alert("There was an error creating Geolocation marker: "+a.message+"\n\nProceeding with normal map generation..");m.error("There was an error obtaining your position. Message: "+a.message);r=null}),r.setPositionOptions({enableHighAccuracy:!0,timeout:6E3,maximumAge:0}),r.setMap(q))},buildAddressMarkers:function(a,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              d,e){w=!0;H=A.trim(a);H=A.searchReplace(H,"'","");"true"===d?(a=F(H),"true"===e?s(a,!0):"false"===e&&s(a,!1)):null!=d&&"false"!==d||b(H,"","","",!1,!1);c()},isBuildAddressMarkersCalled:function(){return w}}},A=function(){return{isNumeric:function(a){return/^([0-9?(\-.,;\s{1,})]+)$/.test(a)},isAlphaNumeric:function(a){return/^([a-zA-Z0-9?(/\-.,\s{1,})]+)$/.test(a)},trim:function(a){return a.replace(/^\s+|\s+$/g,"")},searchReplace:function(a,b,d){return a.replace(RegExp(b,"g"),d)}}}(),m=function(){var a=
    ...
    d.translations=F(d.translations);u=parseFloat(a.fn.jquery.split(".")[0]);t=parseFloat(a.fn.jquery.split(".")[1]);if(1>u||1<=u&&2>u&&3>t)return alert(d.errors.oldJquery),m.fatal("Client uses jQuery older than the version 1.3.0. Aborting map generation .."),!1;if("undefined"===typeof google||!google)return w.alertError(d.errors.msgNoGoogle),m.fatal("We do not have reference to Google API. Aborting map generation .."),!1;if("undefined"!==typeof GMap2&&GMap2)return w.alertError(d.errors.msgApiV2),m.fatal("It looks like the webpage has reference to GMap2 object from Google API v2. Aborting map generation .."),
        !1;d.language=a("object#global-data-placeholder").find("param#language").val();google.load("maps","3",{other_params:"sensor=false&libraries=panoramio&language="+d.language,callback:function(){g()}})}})("undefined"!==typeof g&&null!=g&&g?g:jQuery)}if("undefined"===typeof jQuery||null==jQuery){var K=!1,z=document.head||document.getElementsByTagName("head")[0]||document.documentElement,g=document.createElement("script");g.type="text/javascript";g.src="http://ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js";
    g.onload=g.onreadystatechange=function(){if(!K&&(!this.readyState||/loaded|complete/.test(g.readyState))){K=!0;var P=jQuery.noConflict();E(P);g.onload=g.onreadystatechange=null;z&&g.parentNode&&z.removeChild(g);g=void 0}};z.appendChild(g)}else E()})();
(function(){function C(q){(function(a){function q(){a("object.cgmp-json-string-placeholder").each(function(l,d){var h=a(d).attr("id"),h=a(d).find("param#json-string-"+h).val(),h=u.searchReplace(h,"'",""),h=h.replace("&quot;",""),e=D(h);if("undefined"===typeof e||!e)return!1;if(0<a("div#"+e.id).length){var n=new google.maps.Map(document.getElementById(e.id));w.initMap(n,e.bubbleautopan,parseInt(e.zoom),e.maptype);x.init(n);h=new C;h.init(n,e.bubbleautopan,e.distanceunits,e.enablegeolocationmarker);
    ...
    google.maps.MVCObject.prototype.set.call(this,"position",c)};p.prototype.watchPosition_=function(){var a=this;navigator.geolocation&&(this.watchId_=navigator.geolocation.watchPosition(function(c){a.updatePosition_(c)},function(c){google.maps.event.trigger(a,"geolocation_error",c)},this.getPositionOptions()))};p.prototype.copyOptions_=function(a,c){for(var b in c)!0!==p.DISALLOWED_OPTIONS[b]&&(a[b]=c[b]);return a};p.DISALLOWED_OPTIONS={map:!0,position:!0,radius:!0};return{init:function(a,c,b,d){r=
        a;m=r.getDiv().id;U=c;J=b;"true"===d&&(v=new p,google.maps.event.addListenerOnce(v,"position_changed",function(){r.setCenter(this.getPosition());r.fitBounds(this.getBounds())}),google.maps.event.addListener(v,"geolocation_error",function(a){alert("There was an error obtaining your position. Message: "+a.message)}),v.setPositionOptions({enableHighAccuracy:!0,timeout:5E3,maximumAge:0}),v.setMap(r));google.maps.event.addListener(r,"click",function(){l()});B=[];M=[];K=[];Q=5;F=N=H=L=null;S=R=!1;X=new google.maps.Geocoder;
        z=new google.maps.LatLngBounds;A=new google.maps.InfoWindow;V=new google.maps.StreetViewService;W=new google.maps.DirectionsService;rendererOptions={draggable:!0};G=new google.maps.DirectionsRenderer(rendererOptions);G.setPanel(document.getElementById("rendered-directions-placeholder-"+m))},buildAddressMarkers:function(a,c,d){S=!0;H=u.trim(a);H=u.searchReplace(H,"'","");if("true"===c)a=D(H),"true"===d?T(a,!0):"false"===d&&T(a,!1),E();else if(null==c||"false"===c){d=H.split("|");for(a=0;a<d.length;a++){var f=
        d[a];null!=f&&""!=f&&(f=u.trim(f),""!=f&&(c=a+1,f=f.split(b.sep),u.isNumeric(f[0])?w(c,f,"","","",!1):(u.isAlphaNumeric(f[0]),s(c,f,"","","",!1))))}E()}},isBuildAddressMarkersCalled:function(){return S}}},u=function(){return{isNumeric:function(a){return/^([0-9?(\-.,;\s{1,})]+)$/.test(a)},isAlphaNumeric:function(a){return/^([a-zA-Z0-9?(/\-.,\s{1,})]+)$/.test(a)},trim:function(a){return a.replace(/^\s+|\s+$/g,"")},searchReplace:function(a,b,h){return a.replace(RegExp(b,"g"),h)}}}(),y=function(){var a=
    function(a){navigator.userAgent.match(/msie|trident/i)||console.log(a)};return{info:function(b){a("Info :: "+b)},raw:function(b){a(b)},warn:function(b){a("Warning :: "+b)},error:function(b){a("Error :: "+b)},fatal:function(b){a("Fatal :: "+b)}}}(),I=function(){return{alertError:function(b){function d(b,d){b.preventDefault();var e=a(d).closest("div.cgmp-popup-shortcode-dialog");e&&a(e).remove();0==a("div.cgmp-popup-shortcode-dialog").length&&a("#cgmp-popup-mask").remove()}var h=a('<div id="cgmp-popup-mask"/>'),
    e=Math.random().toString(36).substring(3),n=a('<div id="'+e+'" class="cgmp-popup-shortcode-dialog cgmp-popup-window">');n.html("<div class='dismiss-container'><a class='dialog-dismiss' href='javascript:void(0)'>\u00c3\u2014</a></div><p style='text-align: left; padding: 10px 10px 0 10px'>"+b+"</p><div align='center'><input type='button' class='close-dialog' value='Close' /></div>");a("body").append(h);a("body").append(n);b=a(document).height();h=a(window).width();a("#cgmp-popup-mask").css({width:h,
    height:b,opacity:0.1});1==a("#cgmp-popup-mask").length&&a("#cgmp-popup-mask").show();b=a(window).height();h=a(window).width();a("div#"+e).css("top",b/2-a("div#"+e).height()/2);a("div#"+e).css("left",h/2-a("div#"+e).width()/2);a("div#"+e).fadeIn(500);a(".cgmp-popup-window .close-dialog").click(function(b){d(b,a(this))});a(".cgmp-popup-window .dialog-dismiss").click(function(b){d(b,a(this))});a("#cgmp-popup-mask").click(function(){a(this).remove();a(".cgmp-popup-window").remove()});a(window).resize(function(){var b=
    a(".window"),d=a(document).height(),e=a(window).width();a("#cgmp-popup-mask").css({width:e,height:d});d=a(window).height();e=a(window).width();b.css("top",d/2-b.height()/2);b.css("left",e/2-b.width()/2)})}}}();if(0!=a("object#global-data-placeholder").length){s=document.head||document.getElementsByTagName("head")[0]||document.documentElement;t=document.createElement("link");t.type="text/css";t.rel="stylesheet";t.href=a("object#global-data-placeholder").find("param#cssHref").val();t.media="screen";
    s.appendChild(t);b.sep=a("object#global-data-placeholder").find("param#sep").val();b.customMarkersUri=a("object#global-data-placeholder").find("param#customMarkersUri").val();b.errors=a("object#global-data-placeholder").find("param#errors").val();b.errors=D(b.errors);b.translations=a("object#global-data-placeholder").find("param#translations").val();b.translations=D(b.translations);s=parseFloat(a.fn.jquery.split(".")[0]);t=parseFloat(a.fn.jquery.split(".")[1]);if(1>s||1<=s&&2>s&&3>t)return alert(b.errors.oldJquery),
        !1;if("undefined"===typeof google||!google)return I.alertError(b.errors.msgNoGoogle),!1;if("undefined"!==typeof GMap2&&GMap2)return I.alertError(b.errors.msgApiV2),!1;b.language=a("object#global-data-placeholder").find("param#language").val();google.load("maps","3",{other_params:"sensor=false&libraries=panoramio&language="+b.language,callback:function(){q()}})}})("undefined"!==typeof q&&null!=q&&q?q:jQuery)}if("undefined"===typeof jQuery||null==jQuery){var P=!1,w=document.head||document.getElementsByTagName("head")[0]||
    document.documentElement,q=document.createElement("script");q.type="text/javascript";q.src="http://ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js";q.onload=q.onreadystatechange=function(){if(!P&&(!this.readyState||/loaded|complete/.test(q.readyState))){P=!0;var Z=jQuery.noConflict();C(Z);q.onload=q.onreadystatechange=null;w&&q.parentNode&&w.removeChild(q);q=void 0}};w.appendChild(q)}else C()})();
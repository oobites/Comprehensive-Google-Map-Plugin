var CGMPGlobal={},jQueryCgmp=jQuery.noConflict();function sendShortcodeToEditor(a){var e=jQueryCgmp;a=buildShortcode("#"+a,muid(),e);send_to_editor("<br />"+a+"<br />")}function confirmShortcodeDelete(a,e){!0==confirm("Are you sure you want to delete shortcode\n'"+e+"' ?")&&(window.location.href=a)}
function displayShortcodeInPopup(a){var e=jQueryCgmp;a=buildShortcode("#"+a,"TO_BE_GENERATED",e);displayPopupWithContent("Upon saving, the shortcode will be available to you in post/page WYSIWYG editor -<br />just look for the map icon in the editor panel<br /><br /><div id='inner-shortcode-dialog'><b>"+a+"</b></div><br />",a,e)}
function displayPopupWithContent(a,e,b){var f=b('<div id="cgmp-popup-mask"/>'),c=Math.random().toString(36).substring(3),g=b('<div id="'+c+'" class="cgmp-popup-shortcode-dialog cgmp-popup-window">');g.html("<div class='dismiss-container'><a class='dialog-dismiss' href='javascript:void(0)'>\u00d7</a></div><p style='padding: 10px 10px 0 10px'>"+a+"</p><div align='center'><input type='button' class='save-dialog' value='Save' /></div>");b("body").append(f);b("body").append(g);a=b(document).height();f=
...
function buildShortcode(a,e,b){var f={},c='[google-map-v3 shortcodeid="'+e+'" ';b(a+" .shortcodeitem").each(function(){var a=b(this).attr("role"),d=b(this).val();"addmarkerlisthidden"===a&&(d=b("<div />").text(d).html(),d=d.replace(RegExp("'","g"),""),d=d.replace(RegExp('"',"g"),""),d=d.replace(RegExp("\\[|\\]","g"),""),d=d.replace(RegExp("\\|","g")," - "));"styles"===a&&(d=d.replace(/\s+/g," "),d=base64_encode(d));"checkbox"===b(this).attr("type")&&(d=b(this).is(":checked"));"radio"===b(this).attr("type")&&
(a=b(this).attr("name"),d=b("input[name="+a+"]:checked").val());if(null===a||"undefined"===typeof a||"undefined"===a)a=b(this).attr("id");null!==a&&""!==a&&null!==d&&""!==d&&(0<a.indexOf("_")&&(a=a.replace(/_/g,"")),0<a.indexOf("hidden")&&(a=a.replace(/hidden/g,"")),null===f[a]||"undefined"===typeof f[a])&&(f[a]=a,c+=a+'="'+d+'" ')});c=c.replace(/^\s\s*/,"").replace(/\s\s*$/,"");return c+="]"}
(function(a){function e(){p=[];a.map(a("div.widget-google-map-container ul.token-input-list, div#google-map-container-metabox ul.token-input-list"),function(b){var l=a(b).attr("id");if(null!=l&&-1==l.indexOf("__i__")){var c=a("#"+b.id+"hidden").val(),d=a(b).tokenInput({holderId:l});null!=c&&""!=c&&(b=c.split("|"),a.map(b,function(a){d.add(a)}));p.push({id:l,obj:d})}})}function b(){a(document).on("focus","input.marker-text-details",function(){-1!=a(this).val().indexOf("Enter marker")&&a(this).val("");
    a(this).removeClass("marker-input-info-text")});a(document).on("blur","input.marker-text-details",function(){""==a(this).val().replace(/^\s+|\s+$/g,"")&&(a(this).addClass("marker-input-info-text"),-1==a(this).attr("id").indexOf("bubble")?a(this).val(CGMPGlobal.defaultLocationText):a(this).val(CGMPGlobal.defaultBubbleText))})}function f(){a(document).on("click","input.add-additonal-location",function(b){var l=a(this).attr("id")+"list",d={};a.map(a(p),function(a){a.id==l&&(d=a.obj)});b="#"+a(this).attr("id")+
    "input";var e="#"+a(this).attr("id").replace("addmarker","locationaddmarkerinput"),f="#"+a(this).attr("id").replace("addmarker","bubbletextaddmarkerinput"),k=a(f).val(),k=k.replace(/^\s+|\s+$/g,""),h="#"+a(this).attr("id")+"icons",n=a(h+" input[name='custom-icons-radio']:checked").val();if(null!=a(e).val()&&""!=a(e).val()&&-1==a(e).val().indexOf("Enter marker")){var m=a(e).val().replace(/^\s+|\s+$/g,"");""!==m&&1<m.length?(k=CGMPGlobal.sep+k,-1!=k.indexOf("Enter marker")&&(k=""),m=m.replace(RegExp("'",
    "g"),""),k=k.replace(RegExp("'","g"),""),k=k.replace(RegExp('"',"g"),""),d.add(m+CGMPGlobal.sep+n+k),g(a(h)),a(h+" img#default-marker-icon").attr("style","cursor: default; "),a(h+" img#default-marker-icon").addClass("selected-marker-image"),a(h+" input#default-marker-icon-radio").prop("checked",!0),a(b).attr("style",""),a(b).addClass("default-marker-icon"),a(e).val(CGMPGlobal.defaultLocationText),a(f).val(CGMPGlobal.defaultBubbleText),a(e).addClass("marker-input-info-text"),a(f).addClass("marker-input-info-text")):
    c(e)}else c(e);return!1})}function c(b){a(b).fadeIn("slow",function(){a(this).addClass("errorToken")});a(b).fadeOut(function(){a(this).removeClass("errorToken");a(this).fadeIn("slow")})}function g(b){a.each(b.children(),function(){var b=a(this).find("img");null!=b&&(a(b).attr("style",""),a(b).removeClass("selected-marker-image"))})}function d(){a(document).on("click","div.custom-icons-placeholder a img",function(){if(null!=a(this).attr("src")){var b=a(this).closest("div.custom-icons-placeholder");
    g(b);a(this).parent("a").siblings('input[name="custom-icons-radio"]').prop("checked",!0);h(b,a(this))}});a(document).on("click","input[name='custom-icons-radio']",function(){var b=a(this).siblings("a").children("img");if(null!=a(b).attr("src")){var c=a(this).closest("div.custom-icons-placeholder");g(c);h(c,b)}})}function h(b,c){a(c).attr("style","cursor: default; ");a(c).addClass("selected-marker-image");var e=a(c).attr("src"),d=a(b).attr("id").replace("icons","input");a("#"+d).attr("style","background: url('"+
    e+"') no-repeat scroll 0px 0px transparent !important");a("#"+d).prop("readonly",!0);a("#"+d).removeClass("default-marker-icon")}function s(){a(document).on("hover","a.google-map-tooltip-marker",function(){var b=a(this).attr("id");a("a#"+b+"[title]").tooltip({effect:"slide",opacity:0.8,tipClass:"google-map-tooltip",offset:[-5,0],events:{def:"click, mouseleave"}});a(document).on("mouseout","a#"+b,function(b){a(this).data("tooltip")&&a(this).data("tooltip").hide()})})}function t(){a(document).on("change",
    ...
    CGMPGlobal.ajaxurl=a("object#global-data-placeholder param#ajaxurl").val();var p=[];a(document).ready(function(){e();f();b();s();d();q();r();v();n();t();w();u();"function"==typeof a("ul.tools-tabs-nav").tabs&&a("ul.tools-tabs-nav").tabs("div.tools-tab-body",{tabs:"li",effect:"default"})});a(document).ajaxSuccess(function(a,b,c){null!=c&&null!=c.data&&0<c.data.indexOf("id_base=comprehensivegooglemap")&&(e(),q(),n(),r())})})(jQueryCgmp);
function base64_encode(a){var e,b,f,c,g=0,d=0,h="",h=[];if(!a)return a;do e=a.charCodeAt(g++),b=a.charCodeAt(g++),f=a.charCodeAt(g++),c=e<<16|b<<8|f,e=c>>18&63,b=c>>12&63,f=c>>6&63,c&=63,h[d++]="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(e)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(b)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(f)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(c);

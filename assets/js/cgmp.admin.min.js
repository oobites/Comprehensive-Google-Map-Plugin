...
(function(a){function d(){p=[];a.map(a("div.widget-google-map-container ul.token-input-list, div#google-map-container-metabox ul.token-input-list"),function(b){var l=a(b).attr("id");if(null!=l&&-1==l.indexOf("__i__")){var c=a("#"+b.id+"hidden").val(),e=a(b).tokenInput({holderId:l});null!=c&&""!=c&&(b=c.split("|"),a.map(b,function(a){e.add(a)}));p.push({id:l,obj:e})}})}function b(){a(document).on("focus","input.marker-text-details",function(){-1!=a(this).val().indexOf("Enter marker")&&a(this).val("");
    ...
    d+"') no-repeat scroll 0px 0px transparent !important");a("#"+e).prop("readonly",!0);a("#"+e).removeClass("default-marker-icon")}function r(){a(document).on("hover","a.google-map-tooltip-marker",function(){var b=a(this).attr("id");a("a#"+b+"[title]").tooltip({effect:"slide",opacity:0.8,tipClass:"google-map-tooltip",offset:[-5,0],events:{def:"click, mouseleave"}});a(document).on("mouseout","a#"+b,function(b){a(this).data("tooltip")&&a(this).data("tooltip").hide()})})}function s(){a(document).on("change",
    "input.marker-geo-mashup",function(b){b=a(this).attr("id");var c=b.replace("mashup","icons"),d=b.replace("addmarkermashup","kml");a(this).is(":checked")?(a("#"+d).closest("fieldset").fadeOut(),a("#"+c).closest("fieldset").fadeOut(),a("#"+b+"hidden").val("true")):(a("#"+d).closest("fieldset").fadeIn(),a("#"+c).closest("fieldset").fadeIn(),a("#"+b+"hidden").val("false"))})}function t(){a(document).on("click","a.insert-shortcode-to-post",function(b){b=a(this).attr("id");a("div.find-box-search input#affected").val(b);
    ...
    a("#"+b).closest("fieldset").hide(),a("#"+d).closest("fieldset").hide()):(a(this).removeAttr("checked"),a("#"+b).closest("fieldset").show(),a("#"+d).closest("fieldset").show())})}function u(){a(document).on("change","input.gps-location-marker",function(b){b=a(this).attr("id");a(this).is(":checked")?a("#"+b+"hidden").val("true"):a("#"+b+"hidden").val("false")})}function q(){a.each(a("input.gps-location-marker"),function(){var b=a(this).attr("id");"true"===a("#"+b+"hidden").val()?a(this).prop("checked",
    !0):a(this).removeAttr("checked")})}CGMPGlobal.sep=a("object#global-data-placeholder param#sep").val();if(null==CGMPGlobal.sep||"undefined"==CGMPGlobal.sep)CGMPGlobal.sep="{}";CGMPGlobal.customMarkersUri=a("object#global-data-placeholder param#customMarkersUri").val();CGMPGlobal.defaultLocationText=a("object#global-data-placeholder param#defaultLocationText").val();CGMPGlobal.defaultBubbleText=a("object#global-data-placeholder param#defaultBubbleText").val();CGMPGlobal.assets=a("object#global-data-placeholder param#assets").val();
    CGMPGlobal.version=a("object#global-data-placeholder param#version").val();CGMPGlobal.shortcodes=a("object#global-data-placeholder param#shortcodes").val();CGMPGlobal.ajaxurl=a("object#global-data-placeholder param#ajaxurl").val();var p=[];a(document).ready(function(){d();f();b();r();e();q();u();n();s();t();"function"==typeof a("ul.tools-tabs-nav").tabs&&a("ul.tools-tabs-nav").tabs("div.tools-tab-body",{tabs:"li",effect:"default"})});a(document).ajaxSuccess(function(a,b,c){null!=c&&null!=c.data&&
        0<c.data.indexOf("id_base=comprehensivegooglemap")&&(d(),q(),n())})})(jQueryCgmp);
